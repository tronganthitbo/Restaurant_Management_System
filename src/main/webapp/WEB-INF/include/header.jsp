...
<html>
    <head>
        ...
        <!--Dung cho header-->
        <link href="<%=request.getContextPath()%>/assets/css/headers.css" rel="stylesheet">
        <style>
            .bd-placeholder-img {
                font-size: 1.125rem;
                text-anchor: middle;
